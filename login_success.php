...
<h3 align="center"><b>
<?php
echo "Welcome "; echo $_SESSION['username']; echo " !";
?></b></h3><h4 align="center"><b>Your result is :</b></h4>
<?php
mysql_select_db("test") or die(mysql_error()); 
$data = mysql_query("SELECT * FROM students WHERE username='".$_SESSION['username']."'") 
 or die(mysql_error()); 
 Print "<table border cellpadding=3 align=\"center\">"; 
 while($info = mysql_fetch_array( $data )) 
 { 
 Print "<tr>"; 
 Print "<tr><td>PHYSICS:</td> <td>".$info['physics'] . "</td></tr> "; 
 Print "<tr><td>MATHS:</td> <td>".$info['maths'] . "</td></tr> "; 
 Print "<tr><td>ELECTRONICS:</td> <td>".$info['electronics'] . "</td></tr> "; 
 Print "<tr><td>PROBABILITY:</td> <td>".$info['prob'] . " </td></tr>"; 
  Print "<tr><td>BIOSYSTEM:</td> <td>".$info['bse'] . " </td></tr>"; 
 Print "<tr><td>PHILOSOPHY:</td> <td>".$info['philosophy'] . " </td></tr>"; 
